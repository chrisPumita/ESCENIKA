...
var span2 = document.getElementsByClassName("closeBtnPhoto")[0];
...
var span = document.getElementsByClassName("closeBtnPhoto2")[0];
...
// When the user clicks on <span> (x), closeBtnPhoto the modalPhotoVirtual2
